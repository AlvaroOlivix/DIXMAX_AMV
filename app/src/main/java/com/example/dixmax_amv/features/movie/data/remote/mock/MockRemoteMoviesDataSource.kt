...
class MockRemoteMoviesDataSource {
    ...
    private val mockMovies = listOf(
        ...
        Movie(
            ...
            "https://pics.filmaffinity.com/the_beekeeper-779745802-large.jpg", mockAwards[3]
        ),
        Movie(
            "05",
            "It",
            "Pelicula de culto de terror fantástico",
            "https://th.bing.com/th/id/OIP.u2k6al3dUi_St8XmtnK0KQAAAA?rs=1&pid=ImgDetMain", mockAwards[3]
        ),Movie(
            "06",
            "Smile 2",
            "Secuela de la saga Smile",
            "https://mlpnk72yciwc.i.optimole.com/cqhiHLc.IIZS~2ef73/w:auto/h:auto/q:75/https://bleedingcool.com/wp-content/uploads/2024/06/S2_DOM_2025x3000_ONLINE_TEASER_ONE_SHEET_TORN_rgb.jpg", mockAwards[3]
        )
    )
